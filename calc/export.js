...
$(document).ready(function(){
	...
	$("body").on("click", "#btn-print-cipher-png", function () { // for future elements
		...
		openImageWindow("#ChartSpot", fileName, 1.1);
	});
	...
	$("body").on("click", "#btn-print-history-png", function () {
		...
		openImageWindow(".HistoryTable", fileName, 1.1);
	});
	$("body").on("click", "#btn-date-calc-png", function () {
		...
		openImageWindow(".dateCalcTable2", fileName, 1.1);
	});
	...
	$("body").on("click", "#btn-print-word-break-png", function () {
		...
		openImageWindow("#BreakTableContainer", fileName, 1.1);
	});
	...
	$("body").on("click", "#btn-print-breakdown-details-png", function () {
		...
		openImageWindow("#BreakdownDetails", fileName, 1.1);
	});
	...
	$("body").on("click", "#btn-num-props-png", function () {
		...
		openImageWindow(".numPropTooltip", fileName, 1.1);
	});
...
function openImageWindow(element, imgName = "", sRatio = window.devicePixelRatio, refresh = false) { // sRatio is scaling, refresh - update the image only
	...
	if ( $(element).length ) { // if specified element exists
		...
		html2canvas($(element)[0], {allowTaint: false, backgroundColor: window.getComputedStyle(document.querySelector('body')).getPropertyValue('background-color'), width: $(element).outerWidth(), height: $(element).outerHeight(), scale: sRatio} ).then((canvas) => { // e.g. html2canvas($("#ChartTable")[0]).then ...
